...
const account1 = {
  ...
  movementsDates: [
    ...
    '2921-01-28T09:15:04.904Z',
    '2021-04-01T10:17:24.185Z',
    '2021-05-08T14:11:59.604Z',
    '2021-05-27T17:01:17.194Z',
    '2021-07-11T23:36:17.929Z',
    '2021-10-06T10:51:36.790Z',
  ],
  currency: 'INR',
  locale: 'en-In', // de-DE
};
...
const account3 = {
  owner: 'Sunita Singh',
  movements: [150000, 400, -150, -90, -210, -9000, 8500, -30],
  interestRate: 1.5,
  pin: 3333,
...
// const now = new Date();
// console.log(now);
// const future = new Date(2019, 11, 5, 10, 30);
// console.log(+future);
// const calcDayPassed = (date1, date2) =>
//   Math.abs(date2 - date1) / (1000 * 60 * 60 * 24);
// const day1 = calcDayPassed(new Date(2021, 11, 10), new Date(2021, 11, 20));
// console.log(day1);
//
